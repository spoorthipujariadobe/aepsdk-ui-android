...
object MockAEPPushTemplateDataProvider {
    ...
    fun getMockedAEPBundleWithAllKeys(): Bundle {
        ...
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.TAG, MOCKED_TAG)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.TITLE, MOCKED_TITLE)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.TEMPLATE_TYPE, PushTemplateType.BASIC.value)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.ACTION_URI, MOCKED_ACTION_URI)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.ACTION_TYPE, PushTemplateConstants.ActionType.NONE.name)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.ACTION_BUTTONS, MOCKED_ACTION_BUTTON_DATA)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.BADGE_COUNT, "5")
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.BODY, MOCKED_BASIC_TEMPLATE_BODY)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.CHANNEL_ID, "2024")
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.EXPANDED_BODY_TEXT, MOCKED_BASIC_TEMPLATE_BODY_EXPANDED)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.BODY_TEXT_COLOR, "FFD966")
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.IMAGE_URL, MOCKED_IMAGE_URI)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.LARGE_ICON, MOCKED_LARGE_ICON)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.BACKGROUND_COLOR, "FFD966")
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.PRIORITY, (MOCKED_PRIORITY))
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.VISIBILITY, MOCKED_VISIBILITY)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.REMIND_LATER_TEXT, MOCK_REMIND_LATER_TEXT)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.REMIND_LATER_TIMESTAMP, MOCK_REMIND_LATER_TIME)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.REMIND_LATER_DURATION, MOCK_REMIND_LATER_DURATION)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.SOUND, "bell")
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.SMALL_ICON, MOCKED_SMALL_ICON)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.TITLE_TEXT_COLOR, "FFD966")
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.TICKER, MOCKED_TICKER)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.VERSION, MOCKED_PAYLOAD_VERSION)
        mockBundle.getString(PushTemplateConstants.PushPayloadKeys.STICKY, "true")
        return mockBundle
    }
}
