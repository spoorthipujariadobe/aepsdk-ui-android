...
class AEPPushTemplateTest {
    ...
    fun `Test AEPPushTemplate initialization with all data`() {
        ...
        assertEquals(2, aepPushTemplate.actionButtonsList?.size)
        ...
        assertEquals("remind me", aepPushTemplate.remindLaterText)
        assertEquals("1234567890", aepPushTemplate.remindLaterTimestamp.toString())
